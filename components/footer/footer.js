...
function Footer() {
    ...
    return (
        <>
            <div className={`flex md:justify-center w-full bg-black-1`}>
                <div className={`lg:w-f_welcome_page 3xl:w-th_welcome_page 4xl:w-t_welcome_page 5xl:w-welcome_page w-full lg:self-center py-6 md:py-10 px-6 md:px-0`}>

                    {/* Add div */}
                    <div className="flex justify-between text-white-1">
                        {/* Add text */}
                        <div className="text-xs hidden md:flex">
                            GlobalFintechSummit @2022 Allrights.reserved
                        </div>

                        {/* For small screens */}
                        <div className="text-xs md:hidden">
                            GlobalFintechSummit <br/> @2022 Allrights.reserved
                        </div>

                        {/* Add text */}
                        <div className="font-normal text-xs hidden md:flex">World`s Biggest Fintech Summit</div>

                        {/* Add logos */}
                        <div className="space-x-5 items-center md:space-x-6 flex md:justify-center">
                            {/* Youtube icon */}
