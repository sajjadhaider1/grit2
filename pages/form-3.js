  ...
  return (
    <div className="bg-black-1">
      ...
      <div className="grid w-full h-full grid-cols-12 col-span-12 gap-0">
        ...
        <div className="inline-block p-1.5 font-semibold leading-none bg-blue-1 text-white-1 ">3 of 3</div>
        </div>
          ...
          <div className="flex flex-wrap justify-center mb-10">
            ...
            What is the single most unique thing about your company/product/team/story that would likely spark their interest? </label>
          ...
          <div className="flex flex-wrap justify-center mb-10">
            <label className="w-full text-white-1">
            What does success look like for you at the Conference?</label>
            <input type="text" className="w-full p-3 py-5 border border-solid rounded text-white-1 bg-black-1 border-white-1"
              id="abc" placeholder="List 1-2 things that you would like to get out exhibiting at this conference" />
          </div>
