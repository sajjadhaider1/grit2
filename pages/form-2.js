  ...
  return (
    <div className="bg-black-1">
      ...
      <div className="grid w-full h-full grid-cols-12 col-span-12 gap-0">
        ...
        <div className="inline-block p-1.5 font-semibold leading-none bg-blue-1 text-white-1 ">2 of 3</div>
        </div>
          ...
          <div className="flex flex-wrap justify-center mb-10">
            ...
            Who are your current investors?</label>
          ...
          <div className="flex flex-wrap justify-center mb-10">
            <label className="w-full text-white-1">
            How much are you currently raising?</label>
            <input type="text" className="w-full p-3 border border-solid rounded text-white-1 bg-black-1 border-white-1"
              id="abc" placeholder=" " />
          </div>
          ...
          <div className="flex flex-wrap justify-center mb-10">
            <label className="w-full text-white-1">
            Pitch Deck (if applicable)</label>
            <input type="text" className="w-full p-3 py-5 border border-solid rounded text-white-1 bg-black-1 border-white-1"
              id="abc" placeholder="Send us your most recent pitch deck. N.B. if you are selected, this will be shared with matching investors" />
          </div>
